...
.. py:class:: TwoKeyDict(data = None)
   ...
   Bases: :py:obj:`collections.abc.MutableMapping`\ [\ :py:obj:`_KT`\ , :py:obj:`_KT`\ , :py:obj:`_VT`\ ]
   ...
   .. py:method:: __getitem__(keys: tuple[_KT, _KT]) -> _VT
                  __getitem__(keys: _KT) -> dict[_KT, _VT]


   .. py:method:: __setitem__(keys: _KT, value: dict[_KT, _VT]) -> None
                  __setitem__(keys: tuple[_KT, _KT], value: _VT) -> None


   .. py:method:: __delitem__(keys: _KT) -> None
                  __delitem__(keys: tuple[_KT, _KT]) -> None
   ...
   .. py:method:: __contains__(keys: _KT) -> bool
                  __contains__(keys: tuple[_KT, _KT]) -> bool
