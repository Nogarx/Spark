...
.. py:class:: InitializableField(obj)
   ...
   .. py:method:: init(init_kwargs=None, key = None, shape = None, dtype = None, **kwargs)
...
.. py:class:: SparkMetaConfig
   ...
   .. py:method:: map_common_init_patterns(default, factory = dc.MISSING)
      :staticmethod:



.. py:class:: SparkConfig(skip_validation = False, **kwargs)
...
.. py:class:: DefaultSparkConfig(skip_validation = False, **kwargs)
