...
.. py:class:: QStrLineEdit(initial_value, placeholder = '', parent = None, **kwargs)
...
.. py:class:: QString(initial_value, placeholder = '', parent = None)
...
.. py:class:: QIntLineEdit(initial_value, bottom_value = None, placeholder = None, parent = None, **kwargs)
...
.. py:class:: QInt(initial_value = 0, bottom_value = None, placeholder = None, parent = None)
...
.. py:class:: QFloatLineEdit(initial_value, bottom_value = None, placeholder = None, parent = None, **kwargs)
...
.. py:class:: QFloat(initial_value = 0, bottom_value = None, placeholder = None, parent = None)
