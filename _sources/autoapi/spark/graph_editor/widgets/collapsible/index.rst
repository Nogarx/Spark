...
.. py:class:: QCollapsible(title = '', parent = None, expandedIcon = QtWidgets.QStyle.StandardPixmap.SP_ArrowDown, collapsedIcon = QtWidgets.QStyle.StandardPixmap.SP_ArrowRight)

   Bases: :py:obj:`Qt.QtWidgets.QFrame`
   ...
   .. py:method:: expand(animate = False)

      Expand (show) the collapsible section.



   .. py:method:: collapse(animate = False)
