...
.. autoapisummary::
   ...
   spark.graph_editor.ui.inspector_panel.QModuleConfig
   spark.graph_editor.ui.inspector_panel.QControllerConfig
...
.. py:class:: QModuleConfig(node, **kwargs)
...
.. py:class:: QControllerConfig(node, **kwargs)
