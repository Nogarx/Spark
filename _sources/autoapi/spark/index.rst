...
.. py:class:: PortSpecs(payload_type, shape, dtype, description = None)
   ...
   .. py:attribute:: shape
      :type:  spark.core.shape.Shape | spark.core.shape.ShapeCollection | None
...
.. py:class:: InputSpec(payload_type, shape, dtype, is_optional, description = None)
