...
.. toctree::
   ...
   /autoapi/spark/nn/components/delays/dummy/index
...
.. autoapisummary::
   ...
   spark.nn.components.delays.DummyDelays
   spark.nn.components.delays.DummyDelaysConfig
...
.. py:class:: NDelaysConfig(**kwargs)
   ...
   .. py:attribute:: delay_initializer
      :type:  spark.nn.initializers.delay.DelayInitializerConfig
...
.. py:class:: N2NDelaysConfig(**kwargs)
