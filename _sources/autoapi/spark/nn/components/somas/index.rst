...
.. py:class:: LeakySomaConfig(skip_validation = False, **kwargs)
...
.. py:class:: RefractoryLeakySomaConfig(skip_validation = False, **kwargs)
...
.. py:class:: StrictRefractoryLeakySomaConfig(skip_validation = False, **kwargs)
...
.. py:class:: AdaptiveLeakySomaConfig(skip_validation = False, **kwargs)
...
.. py:class:: ExponentialSomaConfig(skip_validation = False, **kwargs)
...
.. py:class:: RefractoryExponentialSomaConfig(skip_validation = False, **kwargs)
...
.. py:class:: AdaptiveExponentialSomaConfig(skip_validation = False, **kwargs)
...
.. py:class:: SimplifiedAdaptiveExponentialSomaConfig(skip_validation = False, **kwargs)
...
.. py:class:: IzhikevichSomaConfig(skip_validation = False, **kwargs)
