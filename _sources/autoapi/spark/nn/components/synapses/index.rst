...
.. py:class:: LinearSynapsesConfig(skip_validation = False, **kwargs)
...
.. py:class:: TracedSynapsesConfig(skip_validation = False, **kwargs)
...
.. py:class:: RDTracedSynapsesConfig(skip_validation = False, **kwargs)
...
.. py:class:: RFSTracedSynapsesConfig(skip_validation = False, **kwargs)
